...
#
#  Plot #4 is a plot of the data collected during 1-Feb-2007 and 2-Feb-2007
#    This is a panel of four graphs showing active power, submetering,
#      voltage and reactive power plotted against time
...
# Plot the Data
  ...
  # graph 3
  plot(x = my_hpc$Datetime, xlab = "datetime", y = my_hpc$Voltage, 
       ylab = "Voltage", type = "l")

  # graph 4
  plot(x = my_hpc$Datetime, xlab = "datetime", y = my_hpc$Global_reactive_power, 
